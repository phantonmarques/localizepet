...
@section('content')
     <div class="card">
          <div class="card-header">
               ...
               <span class="float-right"><a href="{{ route('panel.users.create') }}" class="btn-default">Criar Usuário</a></span>
          </div>
                                   ...
                                   @foreach ($users as $user)
                                        <tr>
                                             ...
                                             <td class="text-center s-nwrap">
                                                  <a href="{{ route('panel.users.edit', $user->id) }}" id="edit" data-toggle="tooltip" data-placement="bottom" title="Editar" class="mr-2">
                                                       <i class="fas fa-edit"></i>
                                                  </a>
                                                  <a href="{{ route('panel.users.show', $user->id) }}" id="view" data-toggle="tooltip" data-placement="bottom" title="Visualizar" class="mr-2">
                                                       <i class="fas fa-info-circle"></i>
                                                  </a>
                                                  <a href="{{ route('panel.users.destroy', $user->id) }}" id="destroy" data-toggle="tooltip" data-placement="bottom" title="Excluir">
