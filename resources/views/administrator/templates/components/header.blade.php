...
<header class="header">
    <div class="logo-container">
        <a href="#" class="logo">
            <img src="{{ asset('images/default/logo.png') }}" width="75" height="35" alt="Porto Admin"/>
        </a>
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-bs-toggle="dropdown">
                <figure class="profile-picture">
                    <img src="{{ asset('images/default/logged-user.jpg') }}" alt="User" class="rounded-circle"
                         data-lock-picture="{{ asset('images/default/logged-user.jpg') }}"/>
                </figure>
                <div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
                    <span class="name">Daniel Marques</span>
